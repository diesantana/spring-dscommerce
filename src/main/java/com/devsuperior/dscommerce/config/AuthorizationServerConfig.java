...
public class AuthorizationServerConfig {
	...
	// Injeção de propriedades do application.properties
	...
	public SecurityFilterChain asSecurityFilterChain(HttpSecurity http) throws Exception {
		...
		// Configura o endpoint de token para usar um conversor de autenticação personalizado
	...
	// Beans para configurações e serviços relacionados ao OAuth2
	@Bean
	...
	// Configuração do cliente registrado para autenticação OAuth2
	@Bean
	...
	// Configuração do gerador de tokens OAuth2 usando JWT
	@Bean
	...
	// Customização do token JWT gerado
	@Bean
	...
	// Configuração do decodificador JWT usando JWK
	@Bean
	public JwtDecoder jwtDecoder(JWKSource<SecurityContext> jwkSource) {
		return OAuth2AuthorizationServerConfiguration.jwtDecoder(jwkSource);
	}

	// Criação de chaves RSA para o JWT
	@Bean
	...
	// Métodos auxiliares para gerar chaves RSA
